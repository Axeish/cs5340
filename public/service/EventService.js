(function(){
    ...
    function EventService(){
        var events = [
                       ...
                       {id: "#010", _id: "010", title: "Health Moms Healthy Kids Centre St. Jamaica Plain", userId: "234", date: "Mon, Dec.7th", beginTime: "5:00PM", endTime: "6:00PM", comment:[{userId: "Tian", message: "this event is boring.", rating: "2.5"}, {userId: "Danjin", message:"I am a new mum, got useful knowledge in this event.", rating: "4.0"}, {userId: "Yuan", message: "the free food is nice", rating: "3.5"}, {userId: "Ashish", message: "The weather is nice today.", rating: "4.0"}], description: "Are you a Mom that wants to become part of an amazing program to keep you moving, eating healthy, and staying healthy? Join us and other JP moms for a FREE wellness program! Zumba, Strength Training, Nutrition Counseling, Hands on cooking classes with food to take home, Health Coaching, AND MORE! FREE playgroup provided for children under 7 and children 7 and older can participate! For more info, visit our website or call 617-514-0633. Hablamos Espanol!"},
                       {id: "#007", _id: "007",  title: "UEB Men Meet-up", userId: "234", date: "Mon, Dec.7th", beginTime: "6:00PM", endTime: "8:00PM", comment:[{userId: "Danjin", message: "This event taught me a lot.", rating: "3.5"}, {userId: "Tian", message:"Made many friends in this event.", rating: "4.5"}, {userId: "Yuan", message: "Ticket is too expensive", rating: "3.5"}, {userId: "Ashish", message: "I could do better.", rating: "3.5"}], description: "Join UCB Men & Fathers to plan our next steps for taking action to address policy issues and create opportunity in our community. Dinner provided!"},
        ...
        function addCommentToEvent(comment, rating, curEvent, curUser, callback){
            console.log(comment)
            for (var index in events){
                if (events[index].id === curEvent.id){
                    events[index].comment.push({
                        userId: curUser.userName,
                        message: comment,
                        rating: rating
                    })
                    console.log(events[index].comment)
                }
            }
            callback();
        }
