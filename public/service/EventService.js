(function(){
    ...
    function EventService(){
        var events = [
                       ...
                       {id: "#007", _id: "007",  title: "UEB Men Meet-up", userId: "234", date: "Mon, Dec.7th", beginTime: "6:00PM", endTime: "8:00PM", comment:[{userId: "Danjin", message: "This event taught me a lot."}, {userId: "Tian", message:"Made many friends in this event."}, {userId: "Yuan", message: "Ticket is too expensive"}, {userId: "Ashish", message: "I could do better."}], description: "Join UCB Men & Fathers to plan our next steps for taking action to address policy issues and create opportunity in our community. Dinner provided!"},
        ...
        function addCommentToEvent(comment, curEvent, curUser, callback){
            console.log(comment)
