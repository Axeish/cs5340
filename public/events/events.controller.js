//(function(){
    ...
    function EventsController($scope, $rootScope, $location, UserService){
        ...
        $scope.update = update;
        $scope.events = [
          {id: "#000", _id: "000", name:'Community Partners in Health Profession', time:'8:00 AM', date:'Mon, Dec.7th', description: "Join UCB Men & Fathers to plan our next steps for taking action to address policy issues and create opportunity in our community. Dinner provided!"},
          ...
          {id: "#003", _id: "003", name:'Community Partners in Health Profession', time:'8:00 AM', date:'Tue, Dec. 8th', description: "Daily Schedule 9:00 to 10:30 Session One 10:30 to 10:45 Break 10:45 to 12:15 Session Two 12:15 to 1:00 Lunch 1:00 to 2:15 Session Three: Workshops/Technology 2:15 to 2:30 Break 2:35 to 3:30 Session Four: Skill Building, Independent Study, Typing Master, 1:1 Case Management"},
          {id: "#004", _id: "004", name:'Positive Parenting', time:'4:30 PM', date:'Tue, Dec.8th', description: "Positive parenting, an interactive workshop series, for parents of children 0-5 years old. TWO MINI SERIES: Parenting Sucess Despite the Stress, Violence Through the Eyes of a Child. Eight sessions on Tuesday Evenings October 20, October 27, November 3, November 10, November 17, December 1, December 8, December 15. NO FEE"},
          {id: "#005", _id: "005", name:'Urban Edge Pre-K Readings Program', time:'5:00 PM', date:'Tue, Dec.8th', description: "Invite Only. Class:Families First."},
          {id: "#006", _id: "006", name:'Community Partners in Health Profession', time:'8:00 AM', date:'Wed, Dec.9th', description: "Daily Schedule 9:00 to 10:30 Session One 10:30 to 10:45 Break 10:45 to 12:15 Session Two 12:15 to 1:00 Lunch 1:00 to 2:15 Session Three: Workshops/Technology 2:15 to 2:30 Break 2:35 to 3:30 Session Four: Skill Building, Independent Study, Typing Master, 1:1 Case Management"},
          ...
          {id: "#008", _id: "008", name:'KIPP Family Council Meeting', time:'6:00 PM', date:'Wed, Dec.9th', description: "First parent council meeting!"},
